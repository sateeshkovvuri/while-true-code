...
registerForm.addEventListener("submit",(submission)=>{
    ...
    fetch("http://localhost:2000/register",{
        ...
        if(data=="ok"){
            window.location.replace("http://localhost:2000/registeredContests")
        }
        else{
...
fetch("http://localhost:2000/allRegisteredContests",{
    "method":"post",
    headers:{
        "Content-Type":"application/json",
    },
    ...
    for(let doc in data){
        ...
        if(data[doc].starttime == null){
            ...
            contestLink.setAttribute("href","http://localhost:2000/contest/"+doc)
            ...
            if(currentTime >= data[doc].starttime && currentTime<endTime){
                ...
                results.setAttribute("href","http://localhost:2000/results/"+doc)
